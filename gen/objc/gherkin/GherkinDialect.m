...
J2OBJC_FIELD_SETTER(GHKGherkinDialect, keywords_, id<JavaUtilMap>)
J2OBJC_FIELD_SETTER(GHKGherkinDialect, language_, NSString *)

@implementation GHKGherkinDialect

- (instancetype __nonnull)initWithNSString:(NSString *)language
                           withJavaUtilMap:(id<JavaUtilMap>)keywords {
  GHKGherkinDialect_initWithNSString_withJavaUtilMap_(self, language, keywords);
  return self;
}
...
void GHKGherkinDialect_initWithNSString_withJavaUtilMap_(GHKGherkinDialect *self, NSString *language, id<JavaUtilMap> keywords) {
  NSObject_init(self);
  JreStrongAssign(&self->language_, language);
  JreStrongAssign(&self->keywords_, keywords);
}

GHKGherkinDialect *new_GHKGherkinDialect_initWithNSString_withJavaUtilMap_(NSString *language, id<JavaUtilMap> keywords) {
  J2OBJC_NEW_IMPL(GHKGherkinDialect, initWithNSString_withJavaUtilMap_, language, keywords)
}

GHKGherkinDialect *create_GHKGherkinDialect_initWithNSString_withJavaUtilMap_(NSString *language, id<JavaUtilMap> keywords) {
  J2OBJC_CREATE_IMPL(GHKGherkinDialect, initWithNSString_withJavaUtilMap_, language, keywords)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(GHKGherkinDialect)
